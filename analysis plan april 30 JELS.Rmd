...
dfcj <- read_csv("rds_prod.experiment.420656.stacked(11).csv")
```
...
florida.p = 8808/45696

cali.p = 9552/45696

us.p = (45696-8808-9552)/45696
...
plot(mms) + ggplot2::facet_wrap(~BY, ncol = 3L)
...
dfcjw =dfcjw %>% 
 mutate(income_num = readr::parse_number(q17_annual_income),
        income_groups = factor(case_when(income_num <50001 ~ "Up to $50,000",
...
ggplot(dfcjw, aes(y=income_groups)) +
  geom_bar()
...
plot(amces_2, vline = 0.5) + ggplot2::facet_wrap(~BY, ncol = 3L) + ggtitle("Republicans Only: Religiousness")

...
table(dfcj$q24_gender_o1_male)

table(dfcj$q24_gender_o3_other)
...
dfcj$year = as.numeric(dfcj$q21_age_write_in)
...
```{r}
# dfcj = dfcj %>% 
#   filter_at(vars(q24_gender_o1_male, q24_gender_o2_female, q24_gender_o3_other), all_vars(is.in(.)))
# 
# any(is.null(dfcj$q24_gender_o1_male))
# 
# any(is.na(dfcj$q24_gender_o2_female))

#'*very weird thing with gender and NULL*
...
## Weights for age, education, ethnicity, sexual orientation, ideology
...
table(dfcj2$q24_gender_o2_female)
...
amceusw.r <- cj(dfcj2, choice_indicator ~ expected_pension + gender_equality + living_wage + salary_equality + labor_rights + environmental_impact + faith_morality + firearms, id = ~ survey_id,
            estimate = "amce",
            by = ~republican)
...
## Calculate with weights for education, age
...
wtp(mnl_pref1_rep, scalePar = "pension")

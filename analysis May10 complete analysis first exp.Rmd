...
mnl_prefam <- logitr(
  ...
  obsID   = "obs_id", 
  panelID = "survey_id",   
  pars    = c("pension", "firearms.num", "fossil_fuels.num","may_employ_children.num",          "no_racial_diversity.num","no_gender_equal_pay.num"), 
  randPars = c(firearms.num = 'n', fossil_fuels.num = 'n', may_employ_children.num = 'n', no_racial_diversity.num = 'n', no_gender_equal_pay.num = 'n'), 
  numMultiStarts = 10) 
